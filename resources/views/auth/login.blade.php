...
<body>
  ...
  <main id="content" role="main" class="main">
    ...
    <div class="container py-5 py-sm-7">
      <a class="d-flex justify-content-center mb-5" href="index.html.htm">
      ...
      <div class="mx-auto" style="max-width: 30rem;">
              ...
              <div class="mb-4">
                <label class="form-label w-100" for="signupSrPassword" tabindex="0">
                  <span class="d-flex justify-content-between align-items-center">
                    <span>Password</span>
                    <a class="form-label-link mb-0" href="authentication-reset-password-basic.html.htm">Forgot Password?</a>
                  </span>
                </label>
        ...
        <div class="position-relative text-center zi-1">
          <small class="text-cap text-body mb-4">Pointer vos heures de travail facilement</small>
