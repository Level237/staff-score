  ...
  <script src="{{ asset('assets/vendor/hs-navbar-vertical-aside/dist/hs-navbar-vertical-aside-mini-cache.js') }}"></script>
        <header id="header" class="navbar navbar-expand-lg navbar-fixed navbar-height navbar-container navbar-bordered bg-white">
            <div class="navbar-nav-wrap">
              <!-- Logo -->
              <a class="navbar-brand" href="index.html.htm" aria-label="Front">
                <img class="navbar-brand-logo" src="{{ asset('assets/svg/logos-light/logo.svg') }}" alt="Logo" data-hs-theme-appearance="default">
                <img class="navbar-brand-logo" src="{{ asset('assets/svg/logos/logo-short-white.svg') }}" alt="Logo" data-hs-theme-appearance="dark">
                <img class="navbar-brand-logo-mini" src="{{ asset('assets/svg/logos/logo-short-white.svg') }}" alt="Logo" data-hs-theme-appearance="default">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body-height">
                        ...
                        <div class="dropdown-item bg-transparent text-wrap">
                          <a class="btn btn-soft-dark btn-xs rounded-pill" href="index.html.htm">
                        ...
                        <a class="dropdown-item" href="index.html.htm">
                      ...
                      <!-- Footer -->
                      <a class="card-footer text-center" href="index.html.htm">
            ...
            <div class="navbar-vertical-container">
              <div class="navbar-vertical-footer-offset">
                ...
                <a class="navbar-brand" href="index.html.htm" aria-label="Front">
                  ...
                  <img class="navbar-brand-logo-mini" src="{{ asset('assets/svg/logos-light/logo.svg') }}" alt="Logo" data-hs-theme-appearance="dark">
                </a>
                  ...
                  <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                    ...
                    <div class="nav-item">
                      ...
                      <div id="navbarVerticalMenuDashboards" class="nav-collapse collapse show" data-bs-parent="#navbarVerticalMenu">
                        <a class="nav-link active" href="index.html.htm">Default</a>
                        <a class="nav-link " href="dashboard-alternative.html.htm">Alternative</a>
                      </div>
                    </div>
                    <!-- End Collapse -->
                    ...
                    <div id="navbarVerticalMenuPagesMenu">
                      ...
                      <div class="nav-item">
                        ...
                        <div id="navbarVerticalMenuPagesUsersMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenu">
                          <a class="nav-link " href="users.html.htm">Overview</a>
                          <a class="nav-link " href="users-leaderboard.html.htm">Leaderboard</a>
                          <a class="nav-link " href="users-add-user.html.htm">Add User <span class="badge bg-info rounded-pill ms-1">Hot</span></a>
                        </div>
                      </div>
                      <!-- End Collapse -->
                      ...
                      <div class="nav-item">
                        ...
                        <div id="navbarVerticalMenuPagesUserProfileMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenu">
                          <a class="nav-link " href="user-profile.html.htm">Profile</a>
                          <a class="nav-link " href="user-profile-teams.html.htm">Teams</a>
                          <a class="nav-link " href="user-profile-projects.html.htm">Projects</a>
                          <a class="nav-link " href="user-profile-connections.html.htm">Connections</a>
                          <a class="nav-link " href="user-profile-my-profile.html.htm">My Profile</a>
                        </div>
                      </div>
                      <!-- End Collapse -->
                      ...
                      <div class="nav-item">
                        ...
                        <div id="navbarVerticalMenuPagesAccountMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenu">
                          <a class="nav-link " href="account-settings.html.htm">Settings</a>
                          <a class="nav-link " href="account-billing.html.htm">Billing</a>
                          <a class="nav-link " href="account-invoice.html.htm">Invoice</a>
                        </div>
                      </div>
                      <!-- End Collapse -->
                      ...
                      <div class="nav-item">
                        ...
                        <div id="navbarVerticalMenuPagesEcommerceMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenu">
                          <a class="nav-link " href="ecommerce.html.htm">Overview</a>
                          ...
                          <div id="navbarVerticalMenuPagesMenuEcommerce">
                            ...
                            <div class="nav-item">
                              ...
                              <div id="navbarVerticalMenuPagesEcommerceProductsMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenuEcommerce">
                                <a class="nav-link " href="ecommerce-products.html.htm">Products</a>
                                <a class="nav-link " href="ecommerce-product-details.html.htm">Product Details</a>
                                <a class="nav-link " href="ecommerce-add-product.html.htm">Add Product</a>
                              </div>
                            </div>
                            <!-- End Collapse -->
                            ...
                            <div class="nav-item">
                              ...
                              <div id="navbarVerticalMenuPagesEcommerceOrdersMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenuEcommerce">
                                <a class="nav-link " href="ecommerce-orders.html.htm">Orders</a>
                                <a class="nav-link " href="ecommerce-order-details.html.htm">Order Details</a>
                              </div>
                            </div>
                            <!-- End Collapse -->
                            ...
                            <div class="nav-item">
                              ...
                              <div id="navbarVerticalMenuPagesEcommerceCustomersMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenuEcommerce">
                                <a class="nav-link " href="ecommerce-customers.html.htm">Customers</a>
                                <a class="nav-link " href="ecommerce-customer-details.html.htm">Customer Details</a>
                                <a class="nav-link " href="ecommerce-add-customers.html.htm">Add Customers</a>
                              </div>
                            </div>
                            <!-- End Collapse -->
                          </div>

                          <a class="nav-link " href="ecommerce-referrals.html.htm">Referrals</a>
                          <a class="nav-link " href="ecommerce-manage-reviews.html.htm">Manage Reviews</a>
                          <a class="nav-link " href="ecommerce-checkout.html.htm">Checkout</a>
                        </div>
                      </div>
                      <!-- End Collapse -->
                      ...
                      <div class="nav-item">
                        ...
                        <div id="navbarVerticalMenuPagesProjectsMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenu">
                          <a class="nav-link " href="projects.html.htm">Overview</a>
                          <a class="nav-link " href="projects-timeline.html.htm">Timeline</a>
                        </div>
                      </div>
                      <!-- End Collapse -->
                      ...
                      <div class="nav-item">
                        ...
                        <div id="navbarVerticalMenuPagesProjectMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuPagesMenu">
                          <a class="nav-link " href="project.html.htm">Overview</a>
                          <a class="nav-link " href="project-files.html.htm">Files</a>
                          <a class="nav-link " href="project-activity.html.htm">Activity</a>
                          <a class="nav-link " href="project-teams.html.htm">Teams</a>
                          <a class="nav-link " href="project-settings.html.htm">Settings</a>
                        </div>
                      </div>
                      <!-- End Collapse -->
                          ...
                          <div id="navbarVerticalMenuAuthenticationMenu">
                            ...
                            <div class="nav-item">
                              ...
                              <div id="navbarVerticalMenuAuthenticationLoginMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuAuthenticationMenu">
                                <a class="nav-link " href="authentication-login-basic.html.htm">Basic</a>
                                <a class="nav-link " href="authentication-login-cover.html.htm">Cover</a>
                              </div>
                            </div>
                            <!-- End Collapse -->
                            ...
                            <div class="nav-item">
                              ...
                              <div id="navbarVerticalMenuAuthenticationSignupMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuAuthenticationMenu">
                                <a class="nav-link " href="authentication-signup-basic.html.htm">Basic</a>
                                <a class="nav-link " href="authentication-signup-cover.html.htm">Cover</a>
                              </div>
                            </div>
                            <!-- End Collapse -->
                            ...
                            <div class="nav-item">
                              ...
                              <div id="navbarVerticalMenuAuthenticationResetPasswordMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuAuthenticationMenu">
                                <a class="nav-link " href="authentication-reset-password-basic.html.htm">Basic</a>
                                <a class="nav-link " href="authentication-reset-password-cover.html.htm">Cover</a>
                              </div>
                            </div>
                            <!-- End Collapse -->
                            ...
                            <div class="nav-item">
                              ...
                              <div id="navbarVerticalMenuAuthenticationEmailVerificationMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuAuthenticationMenu">
                                <a class="nav-link " href="authentication-email-verification-basic.html.htm">Basic</a>
                                <a class="nav-link " href="authentication-email-verification-cover.html.htm">Cover</a>
                              </div>
                            </div>
                            <!-- End Collapse -->
                            ...
                            <div class="nav-item">
                              ...
                              <div id="navbarVerticalMenuAuthentication2StepVerificationMenu" class="nav-collapse collapse " data-bs-parent="#navbarVerticalMenuAuthenticationMenu">
                                <a class="nav-link " href="authentication-2-step-verification-basic.html.htm">Basic</a>
                                <a class="nav-link " href="authentication-2-step-verification-cover.html.htm">Cover</a>
                              </div>
                            </div>
                            <!-- End Collapse -->

                            <a class="nav-link" href="javascript:;" data-bs-toggle="modal" data-bs-target="#welcomeMessageModal">Welcome Message</a>
                            <a class="nav-link " href="error-404.html.htm">Error 404</a>
                            <a class="nav-link " href="error-500.html.htm">Error 500</a>
                          </div>
                        </div>
                      </div>
                      <!-- End Collapse -->
                      ...
                      <div class="nav-item">
                        <a class="nav-link " href="api-keys.html.htm" data-placement="left">
                      ...
                      <div class="nav-item">
                        <a class="nav-link " href="welcome-page.html.htm" data-placement="left">
                      ...
                      <div class="nav-item">
                        <a class="nav-link " href="landing.html.htm" data-placement="left">
                    ...
                    <div class="nav-item">
                      <a class="nav-link " href="apps-kanban.html.htm" data-placement="left">
                    ...
                    <div class="nav-item">
                      <a class="nav-link " href="apps-calendar.html.htm" data-placement="left">
                    ...
                    <div class="nav-item">
                      <a class="nav-link " href="apps-invoice-generator.html.htm" data-placement="left">
                    ...
                    <div class="nav-item">
                      <a class="nav-link " href="apps-file-manager.html.htm" data-placement="left">
                    ...
                    <div class="nav-item">
                      <a class="nav-link " href="layouts/index.html.htm" data-placement="left">
                    ...
                    <div class="nav-item">
                      <a class="nav-link " href="documentation/index.html.htm" data-placement="left">
                    ...
                    <div class="nav-item">
                      <a class="nav-link " href="documentation/typography.html.htm" data-placement="left">
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-auto">
                    <a class="btn btn-primary" href="javascript:;" data-bs-toggle="modal" data-bs-target="#inviteUserModal">
                      <i class="bi-person-plus-fill me-1"></i> Pointer
                    </a>
                  </div>
                  <!-- End Col -->
                </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="table-column-ps-0">
                          <a class="d-flex align-items-center" href="user-profile.html.htm">
                            <div class="flex-shrink-0">
                              <div class="avatar avatar-sm avatar-circle">
                                <img class="avatar-img" src="assets/img/160x160/img10.jpg" alt="Image Description">
                              </div>
                      ...
                      <ul class="navbar-nav">
                        ...
                        <li class="hs-has-sub-menu nav-item">
                          ...
                          <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="dashboardsMegaMenu" style="min-width: 14rem;">
                            <a class="dropdown-item active" href="index.html.htm">Default</a>
                            <a class="dropdown-item " href="dashboard-alternative.html.htm">Alternative</a>
                          </div>
                          <!-- End Mega Menu -->
                        </li>
                        <!-- End Dashboards -->
                          ...
                          <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="pagesMegaMenu" style="min-width: 14rem;">
                            ...
                            <div class="hs-has-sub-menu nav-item">
                              ...
                              <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="usersMegaMenu" style="min-width: 14rem;">
                                <a class="dropdown-item " href="users.html.htm">Overview</a>
                                <a class="dropdown-item " href="users-leaderboard.html.htm">Leaderboard</a>
                                <a class="dropdown-item " href="users-add-user.html.htm">Add User <span class="badge bg-info rounded-pill ms-1">Hot</span></a>
                              </div>
                            </div>
                            <!-- End Users -->
                            ...
                            <div class="hs-has-sub-menu nav-item">
                              ...
                              <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="userProfileMegaMenu" style="min-width: 14rem;">
                                <a class="dropdown-item " href="user-profile.html.htm">Profile</a>
                                <a class="dropdown-item " href="user-profile-teams.html.htm">Teams</a>
                                <a class="dropdown-item " href="user-profile-projects.html.htm">Projects</a>
                                <a class="dropdown-item " href="user-profile-connections.html.htm">Connections</a>
                                <a class="dropdown-item " href="user-profile-my-profile.html.htm">My Profile</a>
                              </div>
                            </div>
                            <!-- End User Profile -->
                            ...
                            <div class="hs-has-sub-menu nav-item">
                              ...
                              <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="accountMegaMenu" style="min-width: 14rem;">
                                <a class="dropdown-item " href="account-settings.html.htm">Settings</a>
                                <a class="dropdown-item " href="account-billing.html.htm">Billing</a>
                                <a class="dropdown-item " href="account-invoice.html.htm">Invoice</a>
                              </div>
                            </div>
                            <!-- End Account -->
                            ...
                            <div class="hs-has-sub-menu nav-item">
                              ...
                              <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="ecommerceMegaMenu" style="min-width: 14rem;">
                                <a class="dropdown-item " href="ecommerce.html.htm">Overview</a>
                                ...
                                <div class="hs-has-sub-menu nav-item">
                                  ...
                                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="productsMegaMenu" style="min-width: 14rem;">
                                    <a class="dropdown-item " href="ecommerce-products.html.htm">Products</a>
                                    <a class="dropdown-item " href="ecommerce-product-details.html.htm">Product Details</a>
                                    <a class="dropdown-item " href="ecommerce-add-product.html.htm">Add Product</a>
                                  </div>
                                </div>
                                <!-- End Products -->
                                ...
                                <div class="hs-has-sub-menu nav-item">
                                  ...
                                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="ordersMegaMenu" style="min-width: 14rem;">
                                    <a class="dropdown-item " href="ecommerce-orders.html.htm">Orders</a>
                                    <a class="dropdown-item " href="ecommerce-order-details.html.htm">Order Details</a>
                                  </div>
                                </div>
                                <!-- End Products -->
                                ...
                                <div class="hs-has-sub-menu nav-item">
                                  ...
                                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="customersMegaMenu" style="min-width: 14rem;">
                                    <a class="dropdown-item " href="ecommerce-customers.html.htm">Customers</a>
                                    <a class="dropdown-item " href="ecommerce-customer-details.html.htm">Customer Details</a>
                                    <a class="dropdown-item " href="ecommerce-add-customers.html.htm">Add Customers</a>
                                  </div>
                                </div>
                                <!-- End Customers -->

                                <a class="dropdown-item " href="ecommerce-referrals.html.htm">Referrals</a>
                                <a class="dropdown-item " href="ecommerce-manage-reviews.html.htm">Manage Reviews</a>
                                <a class="dropdown-item " href="ecommerce-checkout.html.htm">Checkout</a>
                              </div>
                            </div>
                            <!-- End E-commerce -->
                            ...
                            <div class="hs-has-sub-menu nav-item">
                              ...
                              <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="projectsMegaMenu" style="min-width: 14rem;">
                                <a class="dropdown-item " href="projects.html.htm">Overview</a>
                                <a class="dropdown-item " href="projects-timeline.html.htm">Timeline</a>
                              </div>
                            </div>
                            <!-- End Projects -->
                            ...
                            <div class="hs-has-sub-menu nav-item">
                              ...
                              <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="projectMegaMenu" style="min-width: 14rem;">
                                <a class="dropdown-item " href="project.html.htm">Overview</a>
                                <a class="dropdown-item " href="project-files.html.htm">Files</a>
                                <a class="dropdown-item " href="project-activity.html.htm">Activity</a>
                                <a class="dropdown-item " href="project-teams.html.htm">Teams</a>
                                <a class="dropdown-item " href="project-settings.html.htm">Settings</a>
                              </div>
                            </div>
                            <!-- End Project -->
                              ...
                              <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="authenticationMegaMenu" style="min-width: 14rem;">
                                ...
                                <div class="hs-has-sub-menu nav-item">
                                  ...
                                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="loginMegaMenu" style="min-width: 14rem;">
                                    <a class="dropdown-item " href="authentication-login-basic.html.htm">Basic</a>
                                    <a class="dropdown-item " href="authentication-login-cover.html.htm">Cover</a>
                                  </div>
                                </div>
                                <!-- End Log In -->
                                ...
                                <div class="hs-has-sub-menu nav-item">
                                  ...
                                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="signupMegaMenu" style="min-width: 14rem;">
                                    <a class="dropdown-item " href="authentication-signup-basic.html.htm">Basic</a>
                                    <a class="dropdown-item " href="authentication-signup-cover.html.htm">Cover</a>
                                  </div>
                                </div>
                                <!-- End Sign Up -->
                                ...
                                <div class="hs-has-sub-menu nav-item">
                                  ...
                                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="resetPasswordMegaMenu" style="min-width: 14rem;">
                                    <a class="dropdown-item " href="authentication-reset-password-basic.html.htm">Basic</a>
                                    <a class="dropdown-item " href="authentication-reset-password-cover.html.htm">Cover</a>
                                  </div>
                                </div>
                                <!-- End Reset Password -->
                                ...
                                <div class="hs-has-sub-menu nav-item">
                                  ...
                                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="emailVerificationMegaMenu" style="min-width: 14rem;">
                                    <a class="dropdown-item " href="authentication-email-verification-basic.html.htm">Basic</a>
                                    <a class="dropdown-item " href="authentication-email-verification-cover.html.htm">Cover</a>
                                  </div>
                                </div>
                                ...
                                <div class="hs-has-sub-menu nav-item">
                                  ...
                                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="2stepVerificationMegaMenu" style="min-width: 14rem;">
                                    <a class="dropdown-item " href="authentication-2-step-verification-basic.html.htm">Basic</a>
                                    <a class="dropdown-item " href="authentication-2-step-verification-cover.html.htm">Cover</a>
                                  </div>
                                </div>
                                ...
                                <a class="dropdown-item " href="error-404.html.htm">Error 404</a>
                                <a class="dropdown-item " href="error-500.html.htm">Error 500</a>
                              </div>
                            </div>
                            <!-- End Authentication -->

                            <a class="dropdown-item " href="api-keys.html.htm" data-placement="left">API Keys</a>
                            <a class="dropdown-item " href="welcome-page.html.htm" data-placement="left">Welcome Page</a>
                            <a class="dropdown-item " href="landing.html.htm" data-placement="left">Landing Page <span class="badge bg-info rounded-pill ms-1">New</span></a>
                          </div>
                          <!-- End Mega Menu -->
                        </li>
                        <!-- End Pages -->
                        ...
                        <li class="hs-has-sub-menu nav-item">
                          ...
                          <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="appsMegaMenu" style="min-width: 14rem;">
                            <a class="dropdown-item " href="apps-kanban.html.htm">Kanban</a>
                            <a class="dropdown-item " href="apps-calendar.html.htm">Calendar</a>
                            <a class="dropdown-item " href="apps-invoice-generator.html.htm">Invoice Generator</a>
                            <a class="dropdown-item " href="apps-file-manager.html.htm">File Manager</a>
                          </div>
                        </li>
                        <!-- End Apps -->

                        <li class="nav-item">
                          <a class="nav-link " href="layouts/index.html.htm">
